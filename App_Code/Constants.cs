...
public class Constants
{
    ...
    public const string DESIGN_MODE_BTN_HTML_NEW = "<li class=\"dwbBtn\"><a href=\"javascript:void(0)\" id='design' title='Design Mode' class='handCur' onclick='goToDesignMode()'><i class='material-icons'>domain</i><span class='tbCaption'>Design Mode</span></a></li>";
