            ...
            if (typeof tableJson != "undefined") {
                ...
                if (tblType == "table") {
                            ...
                            if (callParentNew("FMoe")[sourFldInd] == "Select") {
                                if (callParentNew("FldIsSql")[sourFldInd] == "True") {
                                    ...
                                    if (options == "") {
                                        ...
                                        tdRow += "<td class=\"input-group-sm\"><select " + isDisabled + tfreadyOnly + allowEmpty + allowDuplicate + " class=\"tem Family form-control\" name=\"" + colNames[i] + "\" id=\"" + (colNames[i] + "R" + j) + "\" value=\"" + ddlSelVal + "\">" + options + "</select></td>";
                                    }
                                    else
                                        tdRow += "<td class=\"input-group-sm\"><select " + isDisabled + tfreadyOnly + allowEmpty + allowDuplicate + " class=\"tem Family form-control\" name=\"" + colNames[i] + "\" id=\"" + (colNames[i] + "R" + j) + "\" value=\"" + colValue + "\">" + options + "</select></td>";
                                }
                            }
                            else if (callParentNew("FMoe")[sourFldInd] == "Accept" && callParentNew("FldIsSql")[sourFldInd] == "True") {
                                tdRow += "<td class=\"input-group-sm\"><input " + isDisabled + tfreadyOnly + allowEmpty + allowDuplicate + " type=\"text\" class=\"tem Family form-control fldtableinput\" name=\"" + colNames[i] + "\" id=\"" + (colNames[i] + "R" + j) + "\" value=\"" + colValue + "\"></td>";
                            }
                            else if (typeof aportionWhat[i] != "undefined" && aportionWhat[i] != "") {
                                tdRow += "<td class=\"input-group-sm\"><input " + isDisabled + tfreadyOnly + allowEmpty + allowDuplicate + " type=\"text\" class=\"tem Family form-control fldtableinput\" readonly name=\"" + colNames[i] + "\" id=\"" + (colNames[i] + "R" + j) + "\" value=\"" + colValue + "\"></td>";
                            }
                            else {
                                if (callParentNew("FDataType")[sourFldInd] == "Numeric") {
                                    tdRow += "<td class=\"input-group-sm\"><input " + isDisabled + tfreadyOnly + allowEmpty + allowDuplicate + " type=\"text\" style=\"text-align:right;\" class=\"tem Family form-control number fldtableinput\" data-fInd=\"" + sourFldInd + "\" name=\"" + colNames[i] + "\" id=\"" + (colNames[i] + "R" + j) + "\" value=\"" + colValue + "\"></td>";
                                }
                                else if (callParentNew("FDataType")[sourFldInd] == "Date/Time") {
                                    tdRow += "<td class=\"input-group-sm\"><input " + isDisabled + tfreadyOnly + allowEmpty + allowDuplicate + " type=\"text\" class=\"tem Family form-control flatpickr-input fldtableinput\" name=\"" + colNames[i] + "\" id=\"" + (colNames[i] + "R" + j) + "\" value=\"" + colValue + "\">";
                    ...
                    for (var i = 0; i < colCount; i++) {
                        ...
                        if (callParentNew("FMoe")[sourFldInd] == "Select") {
                            if (callParentNew("FldIsSql")[sourFldInd] == "True") {
                                formDiv += "<td class=\"input-group-sm\"><select " + isDisabled + tfreadyOnly + allowEmpty + allowDuplicate + " class=\"combotem Family form-control form-select tblFromSelect fldtableinput\" data-control=\"select2\" name=\"" + colNames[i] + "\" id=\"" + (colNames[i] + "R" + 0) + "\" value=\"" + colValue + "\" data-id=\"" + sourceFldId + "\" data-placeholder=\"Select an option\" data-allow-clear=\"true\">";
                                if (colValue != "")
