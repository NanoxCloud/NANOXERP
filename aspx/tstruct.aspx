...
<body onload="ChangeDir('<%=direction%>');" class="content d-flex flex-column flex-column-fluid fs-6 p-0" dir="<%=direction%>">
    <div id="dvlayout" class="d-flex flex-column mvh-100" runat="server">
        <div class="toolbar m-0 p-0 py-1 flex-shrink-0">
            <div class="container-fluid p-0 d-flex flex-stack flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-center flex-nowrap text-nowrap">
                    ...
                    <div class="toolbarRightMenu">
                        ...
                        <span class="align-items-center">
                            <button type="button" class="btn btn-icon btn-white btn-color-gray-500 btn-active-primary shadow-sm menu-dropdown" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end" data-kt-menu-flip="top-end">
                ...
                <div id="designModeToolbar" class="d-none">
                    <div id="dvToolbar" runat="server" class="d-flex align-items-center flex-nowrap text-nowrap mb-1">
                        <a title="TStruct Design Properties" class="btn btn-sm btn-icon btn-white btn-color-gray-500 btn-active-primary me-2 shadow-sm toolbarIcons" id="tstDsignProp" onclick="openProprtySht('tstructPS')"><span class="material-icons material-icons-style material-icons-3">settings</span></a>
                        <a title="DC Layouts" runat="server" class="btn btn-sm btn-icon btn-white btn-color-gray-500 btn-active-primary me-2 shadow-sm toolbarIcons" id="tstDesigDcLayouts" onclick="javascript:DesignFormDcLayouts();"><span class="material-icons material-icons-style material-icons-3">view_quilt</span></a>
                        <a title="Reset Design" class="btn btn-sm btn-icon btn-white btn-color-gray-500 btn-active-primary me-2 shadow-sm toolbarIcons" id="A7" onclick="javascript:ResetButtonClickedWeb();"><span class="material-icons material-icons-style material-icons-3">restart_alt</span></a>
                        <a title="Save" runat="server" class="btn btn-sm btn-icon btn-white btn-color-gray-500 btn-active-primary me-2 shadow-sm toolbarIcons" id="saveDesign" onclick="javascript:SaveDesignerJSONWeb();"><span class="material-icons material-icons-style material-icons-3">save</span></a>
                        <a title="Publish" runat="server" class="btn btn-sm btn-icon btn-white btn-color-gray-500 btn-active-primary me-2 shadow-sm toolbarIcons" id="PublishDesign" onclick="javascript:PublishDesignerJSONWeb();"><span class="material-icons material-icons-style material-icons-3">publish</span></a>
                        <a title="Save" runat="server" visible="false" class="btn btn-sm btn-icon btn-white btn-color-gray-500 btn-active-primary me-2 shadow-sm toolbarIcons" id="PublishSaveDesign" onclick="javascript:SavePublishDesignerJSONWeb();"><span class="material-icons material-icons-style material-icons-3">published_with_changes</span></a>
                        <a title="Run" runat="server" class="btn btn-sm btn-icon btn-white btn-color-gray-500 btn-active-primary me-2 shadow-sm toolbarIcons" id="RunMode" onclick="javascript:goToRenderMode();"><span class="material-icons material-icons-style material-icons-3">play_circle</span></a>
                        <a title="HTML" runat="server" class="btn btn-sm btn-icon btn-white btn-color-gray-500 btn-active-primary me-2 shadow-sm toolbarIcons" id="tstructHtml" onclick="javascript:customTstHtml();"><span class="material-icons material-icons-style material-icons-3">code</span></a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div id="pagebdy" class="container p-0 overflow-auto" style="max-width: inherit;">
            <%--<div class="row" id="heightframe" runat="server">--%>
            <div id="heightframe" runat="server">
                <div id="formContainer" class="col-xl-12">
                    <form id="form1" runat="server" enctype="multipart/form-data">
                        ...
                        <div id="tstructPsWrapper" class="d-none">
                            <table id="tstructPS" class='table table-bordered mt-6 bordered' data-parent="tstructPsWrapper" data-title="TStruct Design Properties" data-save="false">
                                ...
                                <tr data-group='general'>
                                    ...
                                    <td>
                                        <div class="form-check form-switch form-check-custom form-check-solid float-end" onclick="toggleStaticRunMode()">
                                ...
                                <tr data-group='general'>
                                    ...
                                    <td>
                                        <div class="form-check form-switch form-check-custom form-check-solid float-end" onclick="toggleWizardDCOption()">
                        ...
                        <%--  <div id="srchMulSelFlds" class="d-none">
                                        ...
                                        <ContentTemplate>
                                            <div class="d-flex flex-column">
                                                <div class="d-flex flex-row-auto gap-5">
                                                    ...
                                                    <% if (langauge == "ARABIC")
                                                        {%>
                                                    <asp:Label ID="lblsrch" runat="server" meta:resourcekey="lblsrch" class="form-label col-form-label">
                                                    Search For
                                                    </asp:Label>
                                                    <% }
                                                        else
                                                        { %>
                                                    <asp:Label ID="lblwth" runat="server" CssClass="form-label col-form-label" meta:resourcekey="lblwth">
                                                    With
                                                    </asp:Label>
                                                    <%} %>
                        ...
                        <div class="pdfOverlay d-none">
                            <div id="dvPDFDocList" class="panel">
                ...
                <%-- <div id="dvPickList" class="randomDivPl pickLstResultWrapper d-none">
            ...
            <%--<div class="btnAxCustomParents d-none">
            ...
            <%-- <div id="dvCustToolbar" class="d-none">
            </div>--%>
            ...
            <%-- <div id="dvTip" class="randomDiv hide d-none">
            ...
            <%--<div id="dvPrintDoc" class="hide d-none">
            </div>--%>
            ...
            <%-- <div id="dvFooter" runat="server" visible="false">
                <%=dvFooterHtml %>
            </div>--%>
        </div>
        ...
        <div class="footer d-flex flex-lg-column content p-1 pb-4 pt-0 flex-shrink-0 tstructMainBottomFooter">
            <div class="d-flex flex-column flex-md-row">
                <% if (rid != "0" && Request.QueryString["recPos"] != null && Request.QueryString["recPos"] != "" && Request.QueryString["recPos"] != "null" && Request.QueryString["recordid"] != null)
                    { %>
                <div class="text-dark tstructBottomLeftButton">
