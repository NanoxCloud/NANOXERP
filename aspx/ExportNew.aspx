...
<head runat="server">
   ...
   <%-- <script src="../Js/wizard.min.js?v=10" type="text/javascript"></script>--%>
    ...
    <script src="../Js/ExportImport.min.js?v=30" type="text/javascript"></script>
    ...
    <form id="form1" runat="server">
        ...
        <div class="stepper stepper-pills card bg-transparent border-0 h-100 first" id="kt_stepper_example_clickable" data-kt-stepper="true">
                    ...
                    <section class="form-group col-md-12 mb-4">
                        <asp:Label runat="server" class="selectalign form-label col-form-label" AssociatedControlID="ddlExTstruct">
                            <asp:Label runat="server" ID="Label1" meta:resourcekey="lblextstruct" Text="Select Form" /><span class="allowempty">*</span>
                        </asp:Label>
                    ...
                    <section class="form-group col-md-12">
                        <label for="txtExFields" onclick="$('.ms-selectable ul.ms-list').focus();" class="my-4">
                            <asp:Label ID="Label2" runat="server" meta:resourcekey="lbltxtex" class="form-label col-form-label" Text="Fields"></asp:Label><span class="allowempty">*</span>
                        </label>
                        ...
                        <section id="filtersection">
                            <div id="tblpanel">
                                <div class="configRightFormFields row g-3 align-items-center mb-4 my-4" id="lvfld">
                                                        <div class="col-md-4 col-sm-12">
                                                            <asp:Label ID="lblPassword"  class ="form-label col-form-label" runat="server">Field</asp:Label>
                                                        </div>
                              ...
                              <%--  <tr>
                                ...
                                <tr>--%>
                                    ...
                                    <div class="configRightFormFields row g-3 align-items-center mb-4" id="filcond">
                                                        <div class="col-md-4 col-sm-12">
                                                            <asp:Label ID="Label3"  class ="form-label col-form-label" runat="server">Condition</asp:Label>
                                                        </div>
                                                        <div class="col-md-8 col-sm-12">
                                ...
                                <div class="configRightFormFields row g-3 align-items-center mb-4" id="filval11">
                                                        <div class="col-md-4 col-sm-12">
                                                            <asp:Label ID="Label4"  class ="form-label col-form-label" runat="server">Value</asp:Label>
                                                        </div>
                                                        <div class="col-md-8 col-sm-12">
                                ...
                                <div class="configRightFormFields row g-3 align-items-center mb-4" id="filval12">
                                                        <div class="col-md-4 col-sm-12">
                                                            <asp:Label ID="Label5"  class ="form-label col-form-label" runat="server">Value</asp:Label>
                                                        </div>
                                                        <div class="col-md-8 col-sm-12">
                                   ...
                                   <%-- </td>--%>
                                    <div>
                                        <a class="curHand btn btn-icon btn-white btn-color-gray-500 btn-active-primary shadow-sm me-2" tabindex="0" href="javascript:AddNewCondition();"
                                            id="btnAddNew"><span class="material-icons material-icons-style">
																add
															</span></a>
                                        <a class="curHand btn btn-icon btn-white btn-color-gray-500 btn-active-primary shadow-sm" href="javascript:ClearFirstRow();"
                                            id="clearCond" tabindex="0"><span class="material-icons material-icons-style">
																remove
															</span></a>
                                    </div>
                               <%-- </tr>--%>
                            ...
                            <section id="dvNewrow">
                                <table id="tblFilter">
                                                        ...
                                                        <div class="col-md-4 col-sm-12">
                                                             <asp:Label ID="lblexfiletype" runat="server" class="lblleft form-label col-form-label" meta:resourcekey="lblexfiletype" AssociatedControlID="ddlExFileType">
                   ...
                   <%--                                     <div class="clearfix"></div>
                    <section class="form-group col-md-6">
                      ...
                      <div class="configRightFormFields row g-3 align-items-center mb-4">
                                                        <div class="col-md-4 col-sm-12">
                                                             <asp:Label ID="lblexseparator" runat="server" class="lblleft form-label col-form-label" meta:resourcekey="lblexseparator" AssociatedControlID="ddlExSeparator">
                            ...
                            <div class="configRightFormFields row g-3 align-items-center mb-4">
                            <div class="col-md-4 col-sm-12">
                             <asp:Label ID="lblexpfilename" meta:resourcekey="lblexpfilename" runat="server" class="lblleft form-label col-form-label" AssociatedControlID="txtExpFileName">
                    ...
                    <div class="configRightFormFields row g-3 align-items-center mb-4 app form-check form-switch form-check-solid">
                         <%-- <input name="signedin" type="checkbox" id="chkWithHeader" class="m-wrap placeholder-no-fix form-check-input h-25px w-40px" title="With Header">
                                            <label id="lblstaysin" class="form-check-label form-label col-form-label fw-bolder text-dark fs-6 mb-0" for="chkWithHeader">With Header</label>
                        <asp:Label runat="server" class="checkbox-inline form-label col-form-label d-none" AssociatedControlID="chkWithHeader">
                        <asp:CheckBox ID="chkWithHeader1" CssClass="d-none" runat="server" Text="With Header" meta:resourcekey="lblWithHeader" />
                            </asp:Label>--%>
                        
                        <asp:Label runat="server" class="form-label col-form-label" AssociatedControlID="chkWithHeader">
                      ...
                      <%--<<br />--%>
                        <asp:Label runat="server" class="form-label col-form-label" AssociatedControlID="chkExWithQuotes">
                            <input id="chkExWithQuotes"  type="checkbox" class="m-wrap placeholder-no-fix form-check-input h-25px w-40px" onclick="javascript:SetExType();" runat="server" meta:resourcekey="lblWithQuotes" />With Quotes
                        </asp:Label>
                    ...
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Always">
                        ...
                        <ContentTemplate>
                            ...
                            <asp:HyperLink ID="lnkExpFile" CssClass="btn-primary btn " runat="server" Visible="false" ToolTip="Download"></asp:HyperLink>
