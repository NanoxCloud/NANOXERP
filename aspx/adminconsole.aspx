...
<body class="header-fixed header-tablet-and-mobile-fixed toolbar-enabled aside-fixed aside-default-enabled page-loading" data-kt-aside-minimize="off" dir="<%=direction%>">
        ...
        <div class="adminMain d-flex flex-column flex-root">
            <div class="adminMainInner page d-flex flex-row flex-column-fluid">
                <div class="aside aside-default aside-hoverable" data-kt-drawer="true" data-kt-drawer-name="aside" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'200px', '300px': '250px'}" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_aside_toggle">
                    <div class="adminMainLeft aside-menu flex-column-fluid">
                        <div class="adminLeftMenu menu menu-column menu-fit menu-rounded menu-title-gray-600 menu-icon-gray-400 menu-state-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500 fw-bold fs-5 my-5 mt-lg-2 mb-lg-0" data-kt-menu="true">
                ...
                <div class="wrapper d-flex flex-column flex-row-fluid">
                    <div id="kt_header" class="header" data-kt-sticky="true" data-kt-sticky-name="header" data-kt-sticky-offset="{default: '0px', lg: '0px'}">
						<!--begin::Container-->
						<div class="d-flex align-items-stretch justify-content-between"><%--container-fluid--%>
							<!--begin::Logo bar-->
                ...
                <div class="content fs-6 d-flex flex-column flex-column-fluid pt-9 pb-0 px-9 adminRightGap">
        ...
        <script src="../js/adminconsole.js?v=3" type="text/javascript"></script>
