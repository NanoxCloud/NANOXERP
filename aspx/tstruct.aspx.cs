...
public partial class Tstruct : System.Web.UI.Page
{
    ...
    private void getFormLayoutClass()
    {
        ...
        try
        {
            if (strObj.axdesignJObject != null)
            {
                ...
                {
                    case "center":
                        formPosition = "formPositionCenter";
                        break;
                    case "left":
                        formPosition = "formPositionLeft";
                        break;
                    case "right":
                        formPosition = "formPositionRight";
                        break;
                    default:
                        formPosition = "";
                        break;
    ...
    private void WriteTstJsArrayDef(TStructDef strObj)
    {
        ...
        if (strObj.flds.Count > 0)
        {
            ...
            tstJsArrays.Append("var Expressions = new Array();var Formcontrols = new Array();var tstActionName=new Array();var actParRefresh=new Array();var actSaveTask=new Array();var PatternNames = new Array();var Patterns = new Array();var SFormControls=new Array();var SFCFldNames=new Array();var SFCApply=new Array();var SFCActionName=new Array();var actScriptTask=new Array();");
        ...
        tstJsArrays.Append("var DArray = new Array();var PArray = new Array();var CArray = new Array();var FldChkSeparator = new Array();var FldMgsSeparator=new Array();var FFieldType=new Array();var FFieldAcceptApi=new Array();");
        //add general arrays
        ...
        //AxRulesDef Arrays
        tstJsArrays.Append("var AxRDCompType = new Array();var AxRDCompName = new Array();var AxRDValidation = new Array();var AxRDFilter = new Array();var AxRDFormControl = new Array();var AxRDComputeScript = new Array();var AxRDAllowDuplicate = new Array();var AxRDAllowEmpty = new Array();var AxRDIsApplicable=new Array();");
    ...
    private StringBuilder createModernToolbarButtons(TStructDef strObj, ArrayList buttons, string parentID = "")
    {
        ...
        for (int i = 0; i < buttonList.Count; i++)
        {
            ...
            switch (task)
            {
                ...
                case "search":
                    ...
                    {
                        btnFunction = " onclick=\"javascript:OpenSearch('" + transId + "');\" ";
                        modernToolbarBtnHtml.Append("<a id='" + id + "' " + btnFunction.ToString() + " title='" + (caption == "" ? task : caption) + "' href=\"javascript:void(0)\" class=\"btn btn-icon btn-white btn-color-gray-500 btn-active-primary shadow-sm me-2\"><span class=\"material-icons material-icons-style\">search</span></a>");
                    }
                    break;
                ...
                case "remove":
                    if (isVisible == "true")
                    {
                        ...
                        if (isMobileView)
                            ...
                            modernToolbarBtnHtml.Append("<a id='" + id + "' " + btnFunction.ToString() + " title='" + (caption == "" ? task : caption) + "' href=\"javascript:void(0)\" class=\"btn btn-icon btn-white btn-color-gray-500 btn-active-primary shadow-sm me-2\"><span class=\"material-icons material-icons-style\">remove</span></a>");
                        else
                            footerbuttonList.Add("ftbtn_iRemove");
                    }
                    break;
                    ...
                    if (isVisible == "true")
                    {
                        ...
                        if (strObj.tstPform == "yes")
                        {
                            if (isMobileView)
                                ...
                                modernToolbarBtnHtml.Append("<a id='" + id + "' " + btnFunction.ToString() + " title='" + (caption == "" ? task : caption) + "' href=\"javascript:void(0)\" class=\"btn btn-icon btn-white btn-color-gray-500 btn-active-primary shadow-sm me-2\"><span class=\"material-icons material-icons-style\">print</span></a>");
                        }
                    }
                    break;
                case "pdf":
                ...
                case "listview":
                    if (isVisible == "true")
                    {
                        ...
                        if (isMobileView)
                            ...
                            modernToolbarBtnHtml.Append("<a id='" + id + "' " + btnFunction.ToString() + " title='" + (caption == "" ? task : caption) + "' href=\"javascript:void(0)\" class=\"btn btn-icon btn-white btn-color-gray-500 btn-active-primary shadow-sm me-2\"><span class=\"material-icons material-icons-style\">format_list_bulleted</span></a>");
                        else
                        {
                            footerbuttonList.Add("ftbtn_iList");
                            btnfooterlist = "javascript:CallListView('" + transId + "')";
                ...
                case "tasks":
                    if (isVisible == "true")
                    {
                        ...
                        {
                            if (btnType == "classic")
                                BtnHtml.Append("<div class=\"menu-item px-3\" data-kt-menu-trigger=\"click\" data-kt-menu-placement=\"left-start\" data-kt-menu-flip=\"center, top\"><a href=\"javascript:void(0)\" id='tasks' title='Tasks' class=\"menu-link px-3\"><span class=\"menu-title\">" + lblTaskBtn.Text + "</span><span class=\"menu-arrow\"></span></a><div class=\"menu-sub menu-sub-dropdown w-175px py-4\" style=\"\">");
                            else
                                BtnHtml.Append("<div class=\"col-4 menu-item\" data-kt-menu-trigger=\"click\" data-kt-menu-placement=\"bottom-end\" data-kt-menu-flip=\"bottom\"><a href=\"javascript:void(0)\" id='tasks' title='Tasks' class=\"d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded p-3 mb-3 menu-link\"><div class=\"symbol symbol-circle dropdownIconUI symbol-40px\"><span class=\"symbol-label bg-primary text-white fw-normal fs-3 iconUITitle mb-1\">T</span></div><span class=\"dropdownIconName\">" + lblTaskBtn.Text + "</span><span class=\"mt-3 menu-arrow transform-90\"></span></a><div class=\"menu-sub menu-sub-dropdown py-4 w-100 w-sm-350px mh-450px scroll-y\" style=\"\"><div class=\"col-12 d-flex flex-wrap\">");
                        }
                        if (strObj.taskBtns.Count > 0)
                        {
                            if (strObj.dwbToolbar)
                ...
                case "":
                    if (btn.action != "")
                    {
                        ...
                        if (!string.IsNullOrEmpty(btn.fileupload))
                        {
                            if (btn.fileupload == "y")
                            {
                                ...
                                //modernFooterActBtnHtml.Append("<li><a href=\"javascript: void(0)\" id=" + id + " " + btnFunction.ToString() + " class=\"dwbIvBtnbtm\" style=\"display: block;\"><span class=\"material-icons\">" + btn.icon.text + "</span>" + actBtnNames + "</a></li><input type=hidden id='cb_sactbu' name='cb_sactbu'>");
                                else
                                {
                                    if (btnType == "classic")
                            ...
                            else if (btn.fileupload == "a")
                            {
                                ...
                                //modernFooterActBtnHtml.Append("<li><a href=\"javascript: void(0)\" id=" + id + " " + btnFunction.ToString() + " class=\"dwbIvBtnbtm\" style=\"display: block;\"><span class=\"material-icons\">" + btn.icon.text + "</span>" + actBtnNames + "</a></li>");
                                else
                                {
                                    if (btnType == "classic")
                                        BtnHtml.Append("<div class=\"menu-item px-3\"><a href=\"javascript:void(0)\" " + btnFunction.ToString() + " title='" + (caption == "" ? task : caption) + "' class=\"menu-link px-3\"><div class=\"symbol symbol-25px symbol-circle me-5 dropdownIconUI\"><span class=\"symbol-label bg-primary text-white fw-normal fs-3 iconUITitle\">" + strFirstChars + "</span></div><span class=\"dropdownIconName\">" + actBtnNames + "</span></a></div>");
                    ...
                    else if (isScriptApi)
                    {
                        ...
                        //BtnHtml.Append("<li class=\"waves-effect waves-block\"><a href=\"javascript:void(0)\" " + btnFunction.ToString() + " title='" + (caption == "" ? task : caption) + "' class=\"_action _singleaction _handCur _l2\" href=\"javascript:void(0);\"><div class=\"dropdownIconUI\"><span class=\"iconUITitle\">" + strFirstChars.ToUpper() + "</span></div><span class=\"dropdownIconName\">" + actBtnNames + "</span></a></li>");
                    }
                    else
                    {
                        string actBtnName = (caption == "" ? task : caption).ToString();
                        ...
                        //modernFooterActBtnHtml.Append("<li><a href=\"javascript: void(0)\" id=" + id + " class=\"dwbIvBtnbtm\" style=\"display: block;\"><span class=\"material-icons\">" + btn.icon.text + "</span>" + actBtnName + "</a></li>");
                        else
                        {
                            if (btnType == "classic")
        ...
        if (parentID == "")
        {
            BtnHtml.Append(PrintHTMLtoPDFModern(strObj));
            //if (runtimeMod)
            //{
            //    if (btnType == "classic")
            //        BtnHtml.Append("<div class=\"menu-item px-3\"><a href=\"javascript:void(0)\" id='btnRuntimeMod' title='Add New Field' onclick=\"callAxpertConfigStudio('addfield');\" class=\"menu-link px-3\"><div class=\"symbol symbol-25px symbol-circle me-5 dropdownIconUI\"><span class=\"symbol-label bg-primary text-white fw-normal fs-3 iconUITitle\">A</span></div><span class=\"dropdownIconName\">Add New Field</span></a></div>");
            //    else
            //        BtnHtml.Append("<div class=\"col-4\"><a href=\"javascript:void(0)\" id='btnRuntimeMod' title='Add New Field' onclick=\"callAxpertConfigStudio('addfield');\" class=\"d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded p-3 mb-3\"><div class=\"symbol symbol-circle dropdownIconUI symbol-40px\"><span class=\"symbol-label bg-primary text-white fw-normal fs-3 iconUITitle mb-1\">A</span></div><span class=\"dropdownIconName\">Add New Field</span></a></div>");
            //}
            //if (runtimeCriteria)
            //{
            //    if (btnType == "classic")
            //        BtnHtml.Append("<div class=\"menu-item px-3\"><a href=\"javascript:void(0)\" id='btnAddCriteria' title='Add Criteria' onclick=\"callAxpertConfigStudio('addcriteria');\" class=\"menu-link px-3\"><div class=\"symbol symbol-25px symbol-circle me-5 dropdownIconUI\"><span class=\"symbol-label bg-primary text-white fw-normal fs-3 iconUITitle\">C</span></div><span class=\"dropdownIconName\">Add Criteria</span></a></div>");
            //    else
            //        BtnHtml.Append("<div class=\"col-4\"><a href=\"javascript:void(0)\" id='btnAddCriteria' title='Add Criteria' onclick=\"callAxpertConfigStudio('addcriteria');\" class=\"d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded p-3 mb-3\"><div class=\"symbol symbol-circle dropdownIconUI symbol-40px\"><span class=\"symbol-label bg-primary text-white fw-normal fs-3 iconUITitle mb-1\">C</span></div><span class=\"dropdownIconName\">Add Criteria</span></a></div>");
            //}
            if (Session["axDesign"].ToString() == "true")
            {
                if (btnType == "classic")
    ...
    private string PrintHTMLtoPDFModern(TStructDef strObj)
    {
        ...
        try
        {
            if (!string.IsNullOrEmpty(strObj.htmlToPDF))
            {
                ...
                foreach (var htmlbtnlen in htmlToPDFBtns)
                {
                    ...
                    {
                        StringBuilder btnHtml = new StringBuilder();
                        htmlpdfButtons.Append("<li class=\"dropdown-submenu\"><a href=\"javascript:void(0)\" title='Print' class=\"dropdown-toggle printhtmltopdfbtn\" data-toggle=\"dropdown\" data-hover=\"dropdown\" title=\"O\" data-close-others=\"true\"><div class=\"dropdownIconUI\"><span class=\"iconUITitle\">A</span></div><span class=\"dropdownIconName\">" + htmlToPDFBtnName + "</span><i class=\"fa fa-angle-down modernDropdownIcon\" aria-hidden=\"true\"></i></a><ul class=\"dropdown-menu\">");
                        foreach (var htpForms in htmlToPDFForms)
                        {
                            string formName = htpForms.ToString();
                            if (formName.Contains("."))
                                formName = formName.Split('.')[0];
                            btnHtml.Append("<li class=\"waves-effect waves-block printhtmltopdf\"><a href=\"javascript:void(0)\" id='" + htpForms.ToString() + "' class=\"_action _singleaction _handCur _l2\" href=\"javascript:void(0);\"><div class=\"dropdownIconUI\"><span class=\"iconUITitle\">F</span></div><span class=\"dropdownIconName\">" + formName + "</span></a></li>");
                        }
                        htmlpdfButtons.Append(btnHtml.ToString());
                        htmlpdfButtons.Append("</ul></li>");
                    }
                    else if (htmlToPDFForms.Count == 1)
                    {
                        htmlpdfButtons.Append("<li class=\"waves-effect waves-block\"><a href=\"javascript:void(0)\" id='" + htmlToPDFForms[0].ToString() + "' class=\"_action _singleaction _handCur _l2 printhtmltopdf\" href=\"javascript:void(0);\"><div class=\"dropdownIconUI\"><span class=\"iconUITitle\">H</span></div><span class=\"dropdownIconName\">" + htmlToPDFBtnName + "</span></a></li>");
                    }
                }
            }
        }
                ...
                switch (task)
                {
                    ...
                    case "remove":
                        ...
                        if (btnType == "classic")
                            ...
                            taskBtnHtml.Append("<div class=\"col-4\"><a href=\"javascript:void(0)\" " + btnFunction.ToString() + " title='" + (caption == "" ? task : caption) + "' class=\"d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded p-3 mb-3\"><div>R</div><span class=\"fw-boldest\">" + (caption == "" ? task : caption) + "</span></a></div>");
                        break;
                    case "":
                        if (btn.action != "")
                        {
    ...
    private void LoadStructure(TStructDef strObj)
    {
        ...
        else
        {
            ...
            if (rid != "0")
            {
                ...
                loadXml = loadXml + "<root" + actstr + " imagefromdb='" + imagefromdb + "' axpapp='" + proj + "' sessionid='" + sid + "' appsessionkey='" + Session["AppSessionKey"].ToString() + "' username='" + Session["username"].ToString() + "' transid='" + transId + "' recordid='" + rid + "' dcname='" + visibleDCs + "' trace='" + errorLog + "'>";
        ...
        regTransIdRecId.Append("var isWizardTstruct = " + strObj.isWizardTstruct.ToString().ToLower() + "; var hideToolBar = " + strObj.hideToolBar.ToString().ToLower() + ";var dvRefreshFromLoadModern='" + dvRefreshFromLoadModern + "';var AxRulesEngine='" + strObj.strRulesDefEngin + "';");
    ...
    private void parseXMLDoc(string ires)
    {
        if (ires != String.Empty)
        {
            try
            {
                ...
                string selectStr = "<select id=\"pdfFName\" name=\"fname\" class==\"combotem Family\">";
    ...
    [WebMethod]
    public static string GetAutoCompleteData(string tstDataId, string FldName, string FltValue, ArrayList ChangedFields, ArrayList ChangedFieldDbRowNo, ArrayList ChangedFieldValues, ArrayList DeletedDCRows, string pageData, string fastdll, string fldNameAc, string refreshAC, string pickArrow, string parentsFlds, string rfSave, string IsApiFld)
    {
        ...
        try
        {
            ...
            json = objws.GetdllAutoComplete(tstDataId, FldName, FltValue, ChangedFields, ChangedFieldDbRowNo, ChangedFieldValues, DeletedDCRows, pageData, fastdll, fldNameAc, refreshAC, pickArrow, parentsFlds, rfSave, IsApiFld);
            if (json.IndexOf('♠') > -1)
            {
    ...
    public static string GetFormLoadValues(string key, string tstQureystr, string isDraft, string forceRefresh)
    {
        ...
        try
        {
            ...
            else if (strObj.wsPerfFormLoadCall)
            {
                ...
                if (result == string.Empty)
                {
                    ...
                    if (result != "" && flKey != "none")
                        utils.SetFormLoadData(result, transId, flGblExistingKeys);
                }
            }
            if (result != "")
            {
            ...
            string strObjwsPerfEvalExpClient = string.Empty;
            if (strObj.wsPerfEvalExpClient != null && (wsPerfFormLoad == false || isDraft == "true"))
                strObjwsPerfEvalExpClient = string.Join(",", strObj.wsPerfEvalExpClient.Split(','));
