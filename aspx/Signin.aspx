                ...
                <form id="form1" runat="server">
                    ...
                    <asp:Panel runat="server" ID="panelSignin">
                                        ...
                                        <%--<div class="input-icon left">--%>
                                         <div class="d-flex flex-stack">
                                            <asp:Label ID="lblslctproj"  class="form-label fs-6 fw-bolder text-dark" runat="server" meta:resourcekey="lblslctproj">Select Project
														...
														<select class="form-select form-select-solid m-wrap placeholder-no-fix"  runat="server" data-control="select2" data-placeholder="Select Project" data-allow-clear="true" data-select2-id="select2-data-11-3n80" tabindex="-1" aria-hidden="true" onblur="GetProjLang();" id='axSelectProj' name="axSelectProj">
														</select>
													</div>
                                         <%--</div>--%>
                                    </div>
                        ...
                        <div class="fv-plugins-message-container invalid-feedback"></div>
                            ...
                            User Name</asp:Label>
                                            ...
                                            <input class="m-wrap placeholder-no-fix form-control form-control-solid" id="axUserName" runat="server" type="text"
                  ...
                  <%--                     <div class="fv-row mb-4 fv-plugins-icon-container">
                        ...
                        <div class="fv-plugins-message-container invalid-feedback"></div>
                            ...
                            Password</asp:Label>
                                             <%--<a href="/-html-pro/authentication/base/password-reset.html" class="link-primary fs-6 fw-bolder">Forgot Password ?</a>--%>
                                            <a href="javascript:void(0)" class="link-primary fs-6 fw-bolder" onclick="OpenForgotPwd()">
                                        <asp:Label ID="lblForgot" runat="server" meta:resourcekey="lblForgot">Forgot password?</asp:Label>
                                    </a>
                                            </div>     
                                           <input id="axPassword" runat="server" class="m-wrap placeholder-no-fix form-control form-control-solid" type="password" autocomplete="off"
                            ...
                            Keep me sign in?
                                ...
                                <div class=" agform form-check form-switch form-check-custom form-check-solid px-1 align-self-end mb-4" id="axstaysignin" runat="server" visible="false">
                                    <div class="controls my-2">
                                        <div class="input-icon left">
                                            <input type="checkbox" id="signedin" runat="server" class="m-wrap placeholder-no-fix form-check-input h-25px w-40px" title="Keep me sign in?" />
                                ...
                                <div class="form-actions d-flex flex-row flex-column-fluid">
                                    <div class="d-flex flex-row-fluid">
                                    <asp:Button runat="server" Text="Login" title="Login" ID="btnSubmit" class="btn btn-lg btn-primary mb-5 w-100" OnClientClick="return chkLoginForm();" OnClick="btnSubmit_Click" />
                                        </div>
