    ...
    for (var B = 0; B < A.length; B++) {
        if (A[B].id.startsWith("rtf_") || GetDWBFieldType(GetFieldsName(A[B].id)) == "Rich Text") {
            CKEDITOR.replace(A[B], {
                ...
                filebrowserUploadUrl: '/ckImgUpload.ashx',
                filebrowserImageUploadUrl: '/ckImgUpload.ashx?transId=' + transid + '&fldName=' + A[B].id + '',
                filebrowserFlashUploadUrl: '/ckImgUpload.ashx',
